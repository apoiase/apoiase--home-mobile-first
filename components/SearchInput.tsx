...
} from "./plasmic/apoiase_home_mobile_first/PlasmicSearchInput";
...
export interface SearchInputProps extends DefaultSearchInputProps {}

function SearchInput_(props: SearchInputProps, ref: HTMLElementRefOf<"div">) {
  ...
  return <PlasmicSearchInput searchInput={{ ref }} {...props} />;
}

const SearchInput = React.forwardRef(SearchInput_);
