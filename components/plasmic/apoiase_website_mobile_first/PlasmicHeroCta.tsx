...
import sty from "./PlasmicHeroCta.module.css"; // plasmic-import: BIAyqvxAhQxG/css
      ...
      >
        {true ? (
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__z35O6)}
          >
            <h1
        ...
        {(hasVariant(variants, "withImage", "withImage") ? true : true) ? (
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__cOw0, {
              [sty.freeBoxwithImage__cOw04Sfh9]: hasVariant(
                variants,
                "withImage",
                "withImage"
              )
          ...
          >
            <p.PlasmicImg
              ...
              src={{
                src: "/plasmic/apoiase_website_mobile_first/images/apoiaseIllustrationContinuasvg.svg",
                fullWidth: 189,
                fullHeight: 150,
