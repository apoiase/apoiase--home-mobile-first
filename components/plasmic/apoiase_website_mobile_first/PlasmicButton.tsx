...
import sty from "./PlasmicButton.module.css"; // plasmic-import: BHBrHqJAQNB/css
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <ApoiaseIconCheckIcon
                className={classNames(projectcss.all, sty.svg__rvf44)}
                role={"img"}
              />
            ),
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <ApoiaseIconArrowRightIcon
                className={classNames(projectcss.all, sty.svg__qlh14)}
                role={"img"}
              />
            ),
