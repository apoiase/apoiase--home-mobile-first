...
import sty from "./PlasmicSearchInput.module.css"; // plasmic-import: 3wHlcCTYmyQ-/css

import ApoiaseIconSearchIcon from "./icons/PlasmicIcon__ApoiaseIconSearch"; // plasmic-import: XNKkWPucW9qx/icon
