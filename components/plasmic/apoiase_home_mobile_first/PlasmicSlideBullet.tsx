...
import Bullet from "../../Bullet"; // plasmic-import: KlY1otMQz07JRg/component
...
import sty from "./PlasmicSlideBullet.module.css"; // plasmic-import: DzQ1Cxjuuc37kr/css
    ...
    true ? (
      ...
      >
        {true ? (
          <Bullet
            ativo={true}
            className={classNames("__wab_instance", sty.bullet__wvEwV)}
          />
        ) : null}
        {true ? (
          <Bullet className={classNames("__wab_instance", sty.bullet__aMVp)} />
        ) : null}
        {true ? (
          <Bullet className={classNames("__wab_instance", sty.bullet__g9EDk)} />
        ) : null}
        {true ? (
          <Bullet className={classNames("__wab_instance", sty.bullet__cHTn)} />
        ) : null}
        {true ? (
          <Bullet className={classNames("__wab_instance", sty.bullet__sjlK1)} />
        ) : null}
      </p.Stack>
    ) : null
