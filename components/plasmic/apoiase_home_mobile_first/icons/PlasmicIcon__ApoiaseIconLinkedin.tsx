...
export type ApoiaseIconLinkedinIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function ApoiaseIconLinkedinIcon(props: ApoiaseIconLinkedinIconProps) {
...
export default ApoiaseIconLinkedinIcon;
/* prettier-ignore-end */
