...
import sty from "./PlasmicTabItem.module.css"; // plasmic-import: VNFIRMJTctpIiZ/css
    ...
    >
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ApoiaseIconHeartSelectedIcon
                className={classNames(projectcss.all, sty.svg__zFz6S)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "endIcon", "endIcon") ? true : false)
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ApoiaseIconHeartSelectedIcon
                className={classNames(projectcss.all, sty.svg__coz92)}
                role={"img"}
              />
            ),
