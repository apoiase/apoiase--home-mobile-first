...
import sty from "./PlasmicCampaignTitleCard.module.css"; // plasmic-import: Am0T50-t1kAded/css
    ...
    >
      <CampaignTitle
        ...
        campaignAvatar={p.renderPlasmicSlot({
          defaultContents: (
            <CampaignAvatar
              className={classNames("__wab_instance", sty.campaignAvatar__ddx7)}
            />
          ),
