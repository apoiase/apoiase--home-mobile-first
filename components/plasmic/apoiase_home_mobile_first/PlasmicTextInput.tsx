...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: juNpNRvw6PJRJ/css
...
export const defaultTextInput__Args: Partial<PlasmicTextInput__ArgsType> = {
  placeholder: "Digite o nome da Campanha" as const
};
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__b10Le)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__lcIct)}
                role={"img"}
              />
            ),
